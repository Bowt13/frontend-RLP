...
class NavBar extends PureComponent {
	...
	render() {
		...
		if (location.pathname.indexOf('flexicon') <= 0)
			return (
				<header
					className="Header"
			...
			<div
				...
				<AppBar
					...
					iconElementLeft={
						<IconButton
							...
							<NavigationChevronRight viewBox="0 0 17 17" />
						</IconButton>
					}
					iconElementRight={
						<RaisedButton
				...
				<Drawer width="20%" open={this.state.drawer}>
					<AppBar
						...
						iconElementRight={
							<IconButton
								...
								<NavigationChevronLeft viewBox="0 0 17 17" />
							</IconButton>
						}
						style={{
							width: '100%',
					...
					<List
						...
						{this.props.user &&
							this.props.user.role === 'External' && (
								<div>
									<ListItem
										primaryText="Je bestellingen"
										leftIcon={<FeaturedPlayList color="#F09517" />}
										onClick={_ => this.handleDrawerClick('JeBestellingen')}
									/>
									<ListItem
										primaryText="Nieuwe bestelling"
