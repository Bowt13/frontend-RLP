								...
								<td>
									<table style={{ float: 'left' }}>
										<tbody>
											<tr>
												<td>
													<img src="../images/logo_flexicon.png" />
												</td>
												<td>
								...
								<td>
									<table>
										<tbody>
											...
											<tr>
												<td
													style={{ width: '129px', backgroundColor: 'white' }}>
													Op al onze werkzaamheden zijn de algemene voorwaarden
													van de sector kunstoffen industrie van toepassing,
