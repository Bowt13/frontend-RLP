	...
	render() {
		...
		if (this.props.signup.success) {
			if (pathname.indexOf('forgotpassword') <= 0)
				return <Redirect to="/flexicon/nieuwebestelling" />
			else {
			...
			return (
				<div>
					...
					<Paper
						...
						<p>
							Als je een uitnodiging van Flexicon hebt gekregen en de link je
							naar deze pagina brengt, neem alsjeblieft contact op met de
							contactpersoon in de e-mail.
						</p>
					</Paper>
				</div>
			)
			...
			<div className="signup-page">
				...
				<Paper
					...
					{pathname.indexOf('signup') > 0 && (
						<p>
							Kies alsjeblieft een wachtwoord om de registratie van je account
							te voltooien.
						</p>
					)}
