...
import OrderBetalingsInfo from '../components/orders/OrderBetalingInfo'
...
class OrderCreator extends PureComponent {
	...
	handleSubmit = () => {
		...
		this.orderBetalingsInfo.onClick()
		setTimeout(_ => {
							...
							this.props.addOrder(
								{
									...
									shortDescription: this.state.OrderRemarkForm
										.KorteOmschrijving,
								...
								[
									{
										...
										type: 'Bezoekadres',
										telephoneNumber: this.state.OrderAdres.BezoekAdres
											.Telefoonnummer,
										email: null,
										contactPerson: this.state.OrderAdres.BezoekAdres
											.Contactpersoon
									}
								],
							...
							this.props.addOrder(
								{
									...
									shortDescription: this.state.OrderRemarkForm
										.KorteOmschrijving,
									description:
										this.state.OrderRemarkForm.Opdrachtomschrijving || '',
									amount: this.state.OrderRemarkForm.Aantal,
									deliveryDate: this.state.OrderAfleverInfo.LeverDatum || null,
									paymentType: 'cash',
									deliveryId: this.state.OrderAfleverInfo.DeliveryType.id,
								...
								[
									...
									},
									{
										...
										type: 'Afleveradres',
										telephoneNumber: this.state.OrderAdres.AfleverAdres
											.Telefoonnummer,
										email: null,
										contactPerson: this.state.OrderAdres.AfleverAdres
											.Contactpersoon
									}
								],
								this.state.OrderRemarkForm.files[0]
							...
							this.props.addOrder(
								...
								[
									...
									},
									{
										...
										contactPerson: this.state.OrderAdres.FactuurAdres
											.Contactpersoon
									}
								],
								this.state.OrderRemarkForm.files[0]
				...
				<div
					...
					<Paper
						...
						<OrderInfo
							...
							onRef={ref => (this.orderInfo = ref)}
						/>
						<OrderAdressForm
							onChange={handleChange}
							onRef={ref => (this.orderAdressForm = ref)}
						/>
						<OrderRemarkForm
							onChange={handleChange}
							onRef={ref => (this.orderRemarkForm = ref)}
						/>
						<OrderAfleverInfo
							onChange={handleChange}
							onRef={ref => (this.orderAfleverInfo = ref)}
						/>
						<OrderBetalingsInfo
							onChange={handleChange}
							onRef={ref => (this.orderBetalingsInfo = ref)}
						/>
						<br />
						<div
							style={{
...
export default connect(
	mapStateToProps,
	{ addOrder, addOrderNewAPI, getCurrentUser, getDeliveries }
)(OrderCreator)
